											...
											<NavLink to="/"><Logo /></NavLink>
												...
												<div>
													<div className="text-4xl relative font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-600 inline-block">V FOR VETS<span className="font-normal "> Company</span> 
														<div className="absolute top-0 ml-3 left-full bg-gradient-to-br from-gray-500 to-gray-500 text-white text-sm px-2 py-0.5 rounded-md font-normal hidden md:flex">V</div>
													</div>
													<div className="hidden md:block text-xl text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-500 inline-block">FIRST AI VETERINARY ASSISTANT</div>
													<div className="flex">
...
const Logo = () => (
  ...
  >
	<path fill="black" stroke="black" d="M15.05 59.70L3.66 25.49L9.70 25.49L18 53.12L26.26 25.49L32.31 25.49L20.95 59.70L15.05 59.70Z"/>

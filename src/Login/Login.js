		...
		<>
			...
			<div className="align-bottom flex  transform transition-all sm:align-middle transition flex divide-x divide-gray-300 ">
			  ...
			  <Switch>
				...
				<a href={`https://www.vforvets.net/`} className="block text-center bg-gray-100 text-gray-500 text-sm p-3 rounded-b-lg hover:bg-gray-200 cursor-pointer">
					Our Home Here
				</a>
			</div>
		</div>
